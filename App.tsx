...
const pageMeta: Record<string, { title: string; description: string }> = {
  '/': {
    title: 'Big Foot Eagle Consulting | Indigenous Governance & Management Services',
  ...
  '/governance': {
    title: 'Governance Services | Big Foot Eagle Consulting',
  ...
  '/management': {
    title: 'Management Services | Big Foot Eagle Consulting',
  ...
  '/advisory': {
    title: 'Advisory Services | Big Foot Eagle Consulting',
  ...
  '/reconciliation-statement': {
    title: 'Reconciliation Statement | Big Foot Eagle Consulting',
  ...
  '/treaty-relationships': {
    title: 'Treaty Relationships | Big Foot Eagle Consulting',
  ...
  '/our-staff': {
    title: 'About Us | Big Foot Eagle Consulting',
  ...
  '/contact-us': {
    title: 'Contact Us | Big Foot Eagle Consulting',
    description: 'Get in touch with Big Foot Eagle Consulting. Located in Winnipeg, Manitoba. Let\'s discuss how we can support your governance and management goals.'
  }
};
